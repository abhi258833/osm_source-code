    ...
    private EPerson createEPersonFromRestObject(Context context, EPersonRest epersonRest) throws AuthorizeException {
        ...
        try {
            ...
            if (epersonRest.getPassword() != null) {
                ...
                String confirmPassword = epersonRest.getConfirmPassword();

                if (confirmPassword == null || !password.equals(confirmPassword)) {
                    throw new DSpaceBadRequestException("Password and confirm password do not match");
                }

                if (!validatePasswordService.isPasswordValid(password)) {
